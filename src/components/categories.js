...
export default function Categories({
    categories,
    activeCategory,
    onChangeCategory, // Ubah handleChangeCategory menjadi onChangeCategory
}) {
            ...
            >
                ...
                {categories.map((cat, index) => {
                    ...
                    return (
                        <TouchableOpacity
                            key={index}
                            onPress={() => onChangeCategory(cat.strCategory)} // Ubah handleChangeCategory menjadi onChangeCategory
                            style={styles.categoryContainer}
                        >
